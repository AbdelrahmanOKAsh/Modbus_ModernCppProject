...
#include "../ModbusClient/ModbusClient.hpp"
    ...
    class ModbusResponse
    {
        ...
        public:
            ...
            **/
            ...
            [[nodiscard]] const std::vector<ModbusCell> &registerValues()
            {
            ...
            [[nodiscard]] uint16_t numberOfBytesToFollow()
            {
                if (this->functionType() == utils::Read)
                {
                    ...
                    {
                        // Coils
                        return (this->numberOfRegisters() / 8) + (this->numberOfRegisters() % 8 == 0 ? 0 : 1);
                    }
