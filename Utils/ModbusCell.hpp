...
namespace MB
{
    ...
    class ModbusCell
    {
        ...
        public:
             ...
             * @return New cell.
             */
            [[nodiscard]] static ModbusCell initReg(uint16_t reg) { return ModbusCell(reg); }
             ...
             * @return New cell.
             */
            [[nodiscard]] static ModbusCell initCoil(bool coil) { return ModbusCell(coil); }

            /**
             * @brief Checks if cell is coil.
             * @returns Boolean representing result.
             */
            [[nodiscard]] bool isCoil() const { return std::holds_alternative<bool>(_value); };

            /**
             * @brief Checks if cell is register.
             * @returns Boolean representing result.
             */
            [[nodiscard]] bool isReg() const { return std::holds_alternative<uint16_t>(_value); };
